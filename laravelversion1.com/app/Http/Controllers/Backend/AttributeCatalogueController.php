    ...
    public function __construct(
        ...
        $this->middleware(function($request, $next){
            ...
            if ($language) {
                ...
                // Xử lý trường hợp không tìm thấy ngôn ngữ
                // Ví dụ: Sử dụng ngôn ngữ mặc định, hoặc báo lỗi
                $this->language = 20; // Sử dụng ngôn ngữ mặc định (ID của ngôn ngữ mặc định, ví dụ: tiếng Việt)
                // Hoặc có thể throw Exception để báo lỗi:
                // throw new \Exception("Language not found for locale: " . $locale);
            }
