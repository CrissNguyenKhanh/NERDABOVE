...
class Language extends Model
{
    ...
    public function post_catalogues(){
        return $this->belongsToMany(ProductCatalogue::class, 'product_language' , 'language_id', 'product_id')
        ->withPivot(
            'name',
            'canonical',
            'meta_title',
    ...
    public function product_catalogues(){
        return $this->belongsToMany(PostCatalogue::class, 'product_catalogue_language' , 'language_id', 'product_catalogue_id')
        ->withPivot(
            'name',
            'canonical',
            'meta_title',
